...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/get_year_events -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"year\": \"2026\"}"
```
