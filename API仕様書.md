...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/lv1 -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"message\": \"明日の10時40分から旅行\"}"
```
...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/lv2 -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"message\": \"明日から旅行\"}"
```
...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/lv3 -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"message\": \"マイケルと明日10時45分から旅行\"}"
```
...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/def_event -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"start_date\": \"2026-03-09\", \"start_time\": \"10:40:00\", \"end_date\": \"2026-03-10\", \"event_name\": \"旅行\"}"
```
...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/get_month_events -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"year\": \"2026\", \"month\": \"3\"}"
```
...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/update_event -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"task_uuid\": \"fbcf83d0-13e6-419f-83eb-661ea656d7b1\", \"new_start_date\": \"2026-03-10\", \"new_start_time\": \"09:00:00\", \"new_end_date\": \"2026-03-16\", \"new_event_name\": \"旅行（更新）\"}"
```
...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/delete_event -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"task_uuid\": \"fbcf83d0-13e6-419f-83eb-661ea656d7b1\"}"
```
...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/do_today_event -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"task_uuid\": \"fbcf83d0-13e6-419f-83eb-661ea656d7b1\"}"
```
...
**curlサンプル:**
```cmd
curl -s -X POST https://hackutokyo2026.yoimiya.net/rollback_today_event -H "user_uuid: 3c7a9a24-9e34-4f65-bc1e-9a6e6c7d7f12" -H "Content-Type: application/json" -d "{\"task_uuid\": \"fbcf83d0-13e6-419f-83eb-661ea656d7b1\"}"
```
